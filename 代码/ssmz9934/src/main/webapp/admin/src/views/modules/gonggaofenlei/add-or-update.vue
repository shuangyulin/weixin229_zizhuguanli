<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公告分类" prop="gonggaofenlei">
          <el-input v-model="ruleForm.gonggaofenlei" 
              placeholder="公告分类" clearable  :readonly="ro.gonggaofenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公告分类" prop="gonggaofenlei">
              <el-input v-model="ruleForm.gonggaofenlei" 
                placeholder="公告分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `gonggaofenlei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.gonggaofenleiCrossAddOrUpdateFlag = false;
						 this.parent.search();
