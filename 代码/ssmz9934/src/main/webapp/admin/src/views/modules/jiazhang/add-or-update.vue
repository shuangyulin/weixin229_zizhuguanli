<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="班主任工号" prop="banzhurengonghao">
          <el-select :disabled="ro.banzhurengonghao" v-model="ruleForm.banzhurengonghao" placeholder="请选择班主任工号">
            <el-option
                v-for="(item,index) in banzhurengonghaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
  ...
  data() {
	...
	shhf : false,
      ...
      rules: {
          ...
          jiazhangshouji: [
                { required: true, message: '家长手机不能为空', trigger: 'blur' },
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.banzhurengonghaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
