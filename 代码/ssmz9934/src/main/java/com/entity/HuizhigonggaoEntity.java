...
public class HuizhigonggaoEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public HuizhigonggaoEntity() {
		
	}
	
	public HuizhigonggaoEntity(T t) {
		try {
	 ...
	 * 设置：已读时间
	 */
	public void setYidushijian(Date yidushijian) {
		this.yidushijian = yidushijian;
	}
	/**
	 * 获取：已读时间
	 */
	public Date getYidushijian() {
		return yidushijian;
	}
	/**
	 * 设置：跨表用户id
